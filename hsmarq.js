...
let hoverLeft = document.querySelector('.hover-left');
let hoverRight = document.querySelector('.hover-right');

let hoverElements = [hoverLeft, hoverRight];
...
hoverElements.addEventListener("click", () => {
  loop.pause();
});
